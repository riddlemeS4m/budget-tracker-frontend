...
interface TimeClassificationFormProps {
  initial?: Partial<TimeClassification>;
  onSubmit: (data: Pick<TimeClassification, "name">) => Promise<unknown>;
}

export default function TimeClassificationForm({
  initial = {},
  onSubmit,
}: TimeClassificationFormProps) {
