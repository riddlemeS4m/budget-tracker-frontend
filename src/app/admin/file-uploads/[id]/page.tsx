...
export default function FileUploadDetailPage({
  ...
  if (isError || !data)
    return <p className="text-sm text-red-600 dark:text-red-400">Failed to load file upload.</p>;
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        <Link href="/admin/file-uploads" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">
